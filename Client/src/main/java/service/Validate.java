...
public class Validate {
    ...
    public static UUID uuidFromString(String value) throws IllegalArgumentException {
    ...
    public static Object thisType (String value, Field field) throws IllegalArgumentException, ReadValueException {
        if (field.getType().equals(UUID.class)){
            return uuidFromString(value); //6f369f5d-7b26-4d0c-9c35-cb6c980f5f24
